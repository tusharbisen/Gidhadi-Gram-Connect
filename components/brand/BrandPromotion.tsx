...
export default function BrandPromotion() {
  const businesses = [
    {
      ...
      description:
        "Your one-stop shop for daily essentials, groceries, and household items.",
      rating: 4.8,
      reviews: 124,
    ...
    },
    {
      ...
      description:
        "Complete hardware solutions for construction and repair needs.",
      rating: 4.7,
      reviews: 156,
    ...
    },
    {
      ...
      description:
        "Traditional chai and snacks served with love and authentic flavors.",
      rating: 4.6,
      reviews: 203,
    ...
    },
    {
      ...
      description:
        "Latest fashion trends and traditional wear for the entire family.",
      rating: 4.5,
      reviews: 78,
    ...
    },
    {
      ...
      description:
        "Reliable transportation services for goods and passenger travel.",
      rating: 4.4,
      reviews: 92,
  ...
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-orange-50 via-white to-blue-50 mt-8 rounded-2xl  border-2 border-sky-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Support local entrepreneurs and discover quality services right in
            your village. Connect with trusted businesses that serve our
            community.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Join our growing community of local businesses and reach more
                customers in your village.
              </p>
