      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 mb-1">{data.population.total.toLocaleString()}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 mb-1">{data.voters.total.toLocaleString()}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 mb-1">{data.voters.male.toLocaleString()}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 mb-1">{data.voters.female.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-gray-900">{data.infrastructure.landArea.toLocaleString()}</p>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-gray-900">{data.infrastructure.temples}</p>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-gray-900">{data.infrastructure.govtOffices}</p>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-gray-900">{data.infrastructure.schools}</p>
