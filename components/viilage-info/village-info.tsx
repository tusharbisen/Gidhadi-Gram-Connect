      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-4 sm:mb-6 md:mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1">
                {villageData.population.total.toLocaleString()}
              </p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1">
                {villageData.voters.total.toLocaleString()}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug">
                {t("registeredVoters")}
              </p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1">
                {villageData.voters.male.toLocaleString()}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug">
                {t("maleVoters")}
              </p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 hover:shadow-md transition-all duration-200">
            ...
            <div>
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1">
                {villageData.voters.female.toLocaleString()}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug">
                {t("femaleVoters")}
              </p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 mb-4 sm:mb-6 md:mb-8">
          ...
          <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-2 lg:grid-cols-4">
            ...
            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">
                {villageData.infrastructure.landArea.toLocaleString()}
              </p>
            ...
            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">
                {villageData.infrastructure.temples}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-1 leading-snug">
                {t("religiousPlaces")}
              </p>
            ...
            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">
                {villageData.infrastructure.govtOffices}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-1 leading-snug">
                {t("govtOffices")}
              </p>
            ...
            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">
                {villageData.infrastructure.schools}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-1 leading-snug">
                {t("educationalInst")}
              </p>
        ...
        {!villageData.location && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 mb-4 sm:mb-6 md:mb-8">
            <div className="flex items-center justify-center h-60 sm:h-72 md:h-80 bg-gray-50 rounded-lg">
